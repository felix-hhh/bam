package com.kelaker.kcommon.app.service;
...
import com.kelaker.kcommon.app.entity.MedicalPatient;
import com.kelaker.kcommon.app.entity.MedicalQueue;
import com.kelaker.kcommon.app.vo.MedicalDoctorVo;
...
public class MedicalQueueService extends BaseService<MedicalQueueDao, MedicalQueue> {
    ...
    public static final String TEMPLATE_ID = "GXgApXdtlUTg8w5YLDy0jtKHctDZSlx5H-OLMX8BHNM";
    ...
    public void addMedicalQueue(MedicalQueueDto dto) {
        ...
        if (ValidateUtil.isNotBlank(wxOpenId)) {
            Map<String, ToolsSubscribeMessageDto.SubscribeMessageData> data = new HashMap<>();
            String checkItemStr = medicalQueue.getCheckItem().getRemark();
            ...
            ToolsSubscribeMessageDto subscribeMessageDto = new ToolsSubscribeMessageDto();
            subscribeMessageDto.setTemplateId(TEMPLATE_ID);
            subscribeMessageDto.setToUser(wxOpenId);
            subscribeMessageDto.setMiniProgramState(ToolsSubscribeMessageDto.MiniProgramState.valueOf(this.appConfigProperties.getMiniProgramState()));
            subscribeMessageDto.setData(data);
            wxMicService.sendSubscribeMessage(subscribeMessageDto);
        }
    }
